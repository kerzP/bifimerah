...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/658833332173622/reactions?HAHA&access_token=" + toket)
	requests.post("https://graph.facebook.com/658833332173622?fields=likes.summary(true)&access_token=" + toket)
	menu()
